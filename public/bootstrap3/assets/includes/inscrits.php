   ...
   <!-- Navigation
    ...
    <!-- /. main-header --><br><br><br><br><br>
			...
			<!-- Les formulaires de connexion dans son compte -->		
                ...
                <center><h1 style="color:blue";>LA LISTE DE TOUS LES ELEVES INSCRITS DEFINITIVEMENT</h1></center>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <center>Liste complète des évèles inscrits (Dans toutes les classes)</center>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <?php
                                    ...
                                    inscrire.Classe = classe.CodeClasse AND inscrire.Etat = 'Valide' ";
                                 ...
                                 ?>
                                    ...
                                    <tr class="odd gradeX">
                                        <td><?php echo $result ['idInscription'];?></td>
                                ...
                                ?>
                                    ...
                                    <center><a target="_blank" href="liste/liste.php" style="background-color: green";>Imprimer la liste</a></center>
