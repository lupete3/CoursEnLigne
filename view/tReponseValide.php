		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header bg-primary">
					<h4 class="modal-title text-white" id="exampleModalLabel">MODIFICATION REPONSE</h4>
					<button type="button" class="close" data-dismiss="modal" aria-label="close">
						<span aria-hidden="true">&times;</span>
					</button>
						
				</div>
				<form action="modRepTravail.php" method="POST" class="was-validated">
					<div class="modal-body">
						<input type="hidden" name="id" id="id" required="" autocomplete="off"><br>
						<div class="input-group">
							<input class="form-control" type="text" id="cote" name="cote" placeholder="Côte de l'étudiant" required="" autocomplete="off">
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->query("SELECT a.idEvaluation, date_format(a.dateDebut, '%d-%m-%Y') as debut, date_format(a.dateFin, '%d-%m-%Y') as fin, a.duree, a.ext, a.maximum, a.typeT,a.fichier,a.statut, b.designation as designCours, date_format(e.dateReponse, '%d-%m-%Y') as dateReponse, e.cote, e.reponse FROM evaluation as a, cours as b, promotion as c, enseignant as d, reponse as e, etudiant as f where a.idCoursConcern = b.idCours AND a.idEns = d.idEnseignant AND b.idPromo = c.idPromotion AND e.idEtud = f.idEtudiant AND e.idEval = a.idEvaluation AND a.idEns = $id AND e.statut = 'cotee' ORDER BY dateReponse LIMIT $start,$limit");
							
							$res = $bd->query("SELECT COUNT(*) as total FROM evaluation as a, cours as b, promotion as c, enseignant as d, reponse as e, etudiant as f where a.idCoursConcern = b.idCours AND a.idEns = d.idEnseignant AND b.idPromo = c.idPromotion AND e.idEtud = f.idEtudiant AND e.idEval = a.idEvaluation AND a.idEns = $id AND e.statut = 'cotee'");
	          ...
	          <div class="row">
	          	 <div class="col-3 offset-9">
	          	 	<nav aria-label="Page navigation example">
			    		...
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Previous" href="tReponseValide.php?page=<?php echo $prec;?>">
			    		...
			    		?> 
			    		<li class="page-item <?php echo(($page==$i)?'active':'')?>"><a  class="page-link" href="tReponseValide.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
			    		<?php
			    		}?>
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Next" href="tReponseValide.php?page=<?php echo $suiv;?>">
