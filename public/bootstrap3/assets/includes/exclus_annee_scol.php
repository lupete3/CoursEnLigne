   ...
   <!-- Navigation
    ...
    <!-- /. main-header --><br><br><br><br><br>
			...
			<!-- Les formulaires de connexion dans son compte -->		
                ...
                <center><h4 style="color:blue";>LISTES DE TOUS LES ELEVES EXCLUS PAR ANNEE SCOLAIRE</h4></center>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
						...
						<form role="forme" method="post" action="">
                           ...
                           <center>Liste complète des évèles exlus (Par année Scolaire)</center>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
								...
								if(isset($_POST['afficher'])){
                                    ...
                                    inscrire.Classe = classe.CodeClasse AND inscrire.Etat = 'Valide' AND eleve.etat_admission = 'non' AND inscrire.AnneeScol = '$ann'";
                                ...
                                ?>
                                    ...
                                    <center><a target="_blank" href="liste/liste_exclus_annee.php?annee=<?php if(isset($_POST['afficher'])) {echo $ann; } ?>" style="background-color: green";>Imprimer la liste</a></center>
