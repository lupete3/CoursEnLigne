...
<body>
	...
	<div class="container-fluid spacer">
		<div class="col-lg-12 text-uppercase">
                <center>  
                    <h3 style="text-align:center; font-family:century gothic; border:2px solid #0759d4; width:40%;box-shadow: 0px 10px 20px; border-radius: 30px;">Espace Etudiant</h3>
                    </center> 
                </div>
                        ...
                        <div class="comment-widgets scrollable">
                            <div class="d-flex flex-row comment-row " style="text-align: center; ">
                                ...
                                <div class="comment-text w-100">
                                        <a href="coursDispo.php"><h1 style="font-size: 100px" class="font-medium"><i class="fa fa-book"></i> </h1></a>
                                        <h4 class="font-medium"> Cours Disponibles</h4>
					...
					<div class="card">
                        <div class="comment-widgets scrollable">
                            <div class="d-flex flex-row comment-row " style="text-align: center; ">
                                ...
                                <div class="comment-text w-100">
                                        <a href="coursTest.php"><h1 style="font-size: 100px" class="font-medium"><i class="fa fa-search"></i> </h1></a>
                                        <h4 class="font-medium"> Vérifier un travail à passer</h4>
					...
					<div class="card">
                        <div class="comment-widgets scrollable">
                            <div class="d-flex flex-row comment-row " style="text-align: center; ">
                                ...
                                <div class="comment-text w-100">
                                        <a href="tValideEtud.php"><h1 style="font-size: 100px" class="font-medium"><i class="fa fa-folder-open"></i> </h1></a>
                                        <h4 class="font-medium"> Résultats des travaux</h4>
					...
					<div class="card">
                        <div class="comment-widgets scrollable">
                            <div class="d-flex flex-row comment-row " style="text-align: center; ">
                                ...
                                <div class="comment-text w-100">
                                        <a href="coursComment.php"><h1 style="font-size: 100px" class="font-medium"><i class="fa fa-send"></i> </h1></a>
                                        <h4 class="font-medium"> Commenter un cours</h4>
