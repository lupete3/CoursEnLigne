            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
						...
						<form role="forme" method="post" action="inscrits_classes.php">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
								...
								if(isset($_POST['afficher'])){
                                    ...
                                    inscrire.Classe = classe.CodeClasse AND inscrire.Etat = 'Valide' AND eleve.etat_admission = 'oui' AND inscrire.Classe = $cls";
                                ...
                                ?>
                                    ...
                                    <center><a target="_blank" href="liste/liste_annee_classe.php?classe=<?php if(isset($_POST['afficher'])) {echo $cls; } ?>" style="background-color:green;">Imprimer la liste</a></center>
