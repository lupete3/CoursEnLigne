...
<body>
	...
	<div class="container spacer">
		...
		<div class="col-md-12 spacer">
	          <h3 class="title">RESULTAT DES TRAVAUX</span></h3>
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		<?php
							...
							$req = $bd->query("SELECT a.idEvaluation, date_format(a.dateDebut, '%d-%m-%Y') as debut, date_format(a.dateFin, '%d-%m-%Y') as fin, a.duree, a.ext, a.maximum, a.typeT,a.fichier,a.statut, b.designation as designCours, date_format(e.dateReponse, '%d-%m-%Y') as dateReponse, e.cote, e.reponse FROM evaluation as a, cours as b, promotion as c, enseignant as d, reponse as e, etudiant as f where a.idCoursConcern = b.idCours AND a.idEns = d.idEnseignant AND b.idPromo = c.idPromotion AND e.idEtud = f.idEtudiant AND e.idEval = a.idEvaluation AND e.idEtud = $id AND e.statut = 'cotee' ORDER BY dateReponse LIMIT $start,$limit");
							
							$res = $bd->query("SELECT COUNT(*) as total FROM evaluation as a, cours as b, promotion as c, enseignant as d, reponse as e, etudiant as f where a.idCoursConcern = b.idCours AND a.idEns = d.idEnseignant AND b.idPromo = c.idPromotion AND e.idEtud = f.idEtudiant AND e.idEval = a.idEvaluation AND e.idEtud = $id AND e.statut = 'cotee'");
	          ...
	          <div class="row">
	          	 <div class="col-3 offset-9">
	          	 	<nav aria-label="Page navigation example">
			    		...
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Previous" href="tValideEtud.php?page=<?php echo $prec;?>">
			    		...
			    		?> 
			    		<li class="page-item <?php echo(($page==$i)?'active':'')?>"><a  class="page-link" href="tValideEtud.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
			    		<?php
			    		}?>
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Next" href="tValideEtud.php?page=<?php echo $suiv;?>">
