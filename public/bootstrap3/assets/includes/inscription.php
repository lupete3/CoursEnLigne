            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
					...
					<form role="form" method="post" action="">
						...
						<input name="prenom" class="form-control" type="text" placeholder="Enter votre Pré-nom" /><br />
...
<?php
	if(isset($_POST['Enregistrer'])){
		...
		$query=mysql_query ("INSERT INTO eleve (`CodeEleve`, `nom`, `postnom`, `prenom`, `sexe`, `lieu`, `date`, `adresse`, `origine`, `nom_p`, `nom_m`, `prov`, `num`, `password`, `etat_admission`)
							VALUES (NULL, '$n', '$pn', '$prn', '$sexe', '$lieu', '$date', '$ad', '$orig', '$np', '$nm', '$prov', '$num', '$pw', '$etat')");
