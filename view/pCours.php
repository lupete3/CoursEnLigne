		...
		<div class="modal-dialog modal-md" role="document">
			<div class="modal-content">
				<div class="modal-header bg-primary">
					<h4 class="modal-title text-white" id="exampleModalLabel">PROGRAMMER LE COURS</h4>
					<button type="button" class="close" data-dismiss="modal" aria-label="close">
						<span aria-hidden="true">&times;</span>
					</button>
						
				</div>
				<form action="upProgrammeCours.php" method="POST" class="was-validated">
					<div class="modal-body">
						<input type="hidden" name="id" id="id" required="" autocomplete="off"><br>

						<div class="input-group mb-4">	           			
							<div class="input-group-append">
		           			<span class="input-group-text" id="basic-addon2">Date Début</span>
		           		</div>
		           			
		           		<input type="date" id="debut" name="debut" class="form-control" placeholder="Titre du cours" required="" autocomplete="off"><br>
		           		</div><br>
						
						<div class="input-group mb-4">	           			
							<div class="input-group-append">
		           			<span class="input-group-text" id="basic-addon2">Date Fin </span>
		           			</div>
		           			<input type="date" id="fin" name="fin" class="form-control" placeholder="Pondération" required="" autocomplete="off"><br>
		           		</div><br>
					...
					<div class="modal-footer">
						...
						<button type="submit" class="btn btn-primary btn-block">Programmer</button>
					</div>
				</form>				
			</div>
		</div>			
	 				...
	 				<table id="tab" class="display table table-bordered table-striped table">
		          	...
		          	<tbody>
		          		...
		          		<tr>
                                ...
                                <td><?php 
                                echo (($don['debut']=='' || $don['fin'] == '')?'Non Programmé':'Du '.$don['debut'].' au '.$don['fin']);
                                ?></td>
                                <td><?php echo $don['heureTheorique'].' H' ?></td>
                                <td><?php echo $don['heurePratique'].' H' ?></td>
                                <td><?php echo $don['duree'].' H' ?></td>
								...
								<td>
									...
									<button type="button" data-toggle="tooltip" title="Programmer le cours" class="btn btn-primary editBtn"><span class="fa fa-check"></span>
									</button>

									<button type="button" data-toggle="tooltip" title="Arrêter le cours" class="btn btn-primary supBtn"><span class="fa fa-close"></span>
	          ...
	          <div class="row">
	          	 <div class="col-3 offset-9">
	          	 	<nav aria-label="Page navigation example">
			    		...
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Previous" href="pCours.php?page=<?php echo $prec;?>">
			    		...
			    		?> 
			    		<li class="page-item <?php echo(($page==$i)?'active':'')?>"><a  class="page-link" href="pCours.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
			    		<?php
			    		}?>
			    		<li class="page-item">
			    			<a  class="page-link" aria-label="Next" href="pCours.php?page=<?php echo $suiv;?>">
		...
		<div class="modal fade" id="supBtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-md" role="document">
				<div class="modal-content">
					...
					<form action="arretCours.php" method="POST" class="was-validated">
						<div class="modal-body">
							<input type="hidden" name="id" id="idSup" required="" autocomplete="off"><br>
							<h2 class="text-center">Vous êtes sur le point de rétirer ce cours au programme</h2>
